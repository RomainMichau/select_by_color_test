export function generateGrid(rows: number, cols: number, centerSize: number, centerValue: number): number[][] {
...
export function serialize(coord: Coord): string {
...
export const interestPoint1 = {x:0, y:0} // 1
// [ '0,0', '0,1', '0,2', '0,3', '1,0', '1,1' ]

export const interestPoint2 = {x:15, y:2} // 7
// [
...
//   '16,1',  '16,19'
// ]
export const interestPoint3 = {x:19, y:19} // 8
// [
//   '17,17', '17,18',
//   '17,19', '18,17',
//   '18,18', '18,19',
...
//   '19,19'
// ]
export const interestPoint4 = {x:18, y:1} // { elems: Set(1) { '18,1' }, col: 6 }